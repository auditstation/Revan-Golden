...
class ResConfigSettings(models.TransientModel):
    ...
    is_billing_phone = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_billing_phone',
    ...
    is_billing_phone_is_required = fields.Boolean(
        ...
        config_parameter='website_ecomm_address'
    ...
    is_billing_street = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_billing_street',
    ...
    is_billing_street2 = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_billing_street2',
        help="Enable or disable the option for billing street 2")
    is_billing_city = fields.Boolean(
        string="Billing City",
        config_parameter='website_ecomm_address.is_billing_city',
    ...
    is_billing_zip_code = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_billing_zip_code',
    ...
    is_shipping_phone = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_shipping_phone',
    ...
    is_shipping_street = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_shipping_street',
    ...
    is_shipping_street2 = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_shipping_street2',
        help="Enable or disable the option for shipping street 2")
    is_shipping_city = fields.Boolean(
        string="Shipping City",
        config_parameter='website_ecomm_address.is_shipping_city',
    ...
    is_shipping_zip_code = fields.Boolean(
        ...
        config_parameter='website_ecomm_address.is_shipping_zip_code',
